...
def draw_block(x, y, color):
    ...
    pygame.draw.rect(screen, (0, 0, 0), (x + 3, y + 3, CELL_SIZE - 6, CELL_SIZE - 6), 2)
...
def draw_board():
    for (x, y), color in placed_blocks.items():
        block_color = settings.generate_random_color() if settings.settings["glow_effect"] else color
        draw_block(x * CELL_SIZE, y * CELL_SIZE, block_color)
